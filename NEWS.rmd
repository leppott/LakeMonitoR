...
* refactor: Add hooks in Shiny for selectInput boxes for column selections to 
use data instead of free text, Issue #11
...
* fix: Update stratification() plot for julian day
    + %j starts with 1 so subtract 1 to keep Jan 1 as day 1 with origin date of
    "2004-01-01".
...
* function: Add Shiny app function to calculate stratification with different
...
* refactor: Rename log files with prefix "_log_"
